...
interface ResponsePreparationPhaseProps {
  project: Project;
}

export const ResponsePreparationPhase: React.FC<ResponsePreparationPhaseProps> = ({ project }) => {
  ...
  const toggleValidationItem = (id: string) => {
